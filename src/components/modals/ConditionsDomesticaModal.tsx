...
export const ConditionsDomesticaModal: React.FC = () => {
            ...
            <div className="relative w-full max-w-4xl max-h-[90vh] flex flex-col rounded-2xl shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <div className="bg-white flex-1 overflow-y-auto p-8 text-slate-600 leading-relaxed custom-scrollbar">
                    <div className="min-w-full overflow-x-auto">
                        <p>
                            Oferta para nuevos clientes de GLP con domicilio en las comunidades de Catalunya,
                            Galicia, País Vasco, Cantabria y Asturias (que hayan superado el análisis de riesgo de
                            crédito, así como los demás requisitos necesarios para que los términos la oferta se
                            concreten en un acuerdo). Esta oferta sólo será válida para solicitudes realizadas en
                            2026 e incluye: (i) instalación gratuita de un tanque aéreo de hasta 4.880L, con
