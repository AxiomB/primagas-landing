    ...
    return (
        <section>
            <div className="bg-red-600 p-6 text-white text-center">
                ...
                <p className="text-xs text-dark opacity-80 italic">Solo para nuevos clientes</p>
                <p className="text-xs text-white  italic">¡Date prisa, solo para las 50 primeras instalaciones!</p>
            </div>
