            ...
            <div className="p-8">
                <div className="flex items-start gap-4 mb-6">
                    <div className="bg-red-50 pt-1 pb-3 px-3 rounded-full">
                        <img className='w-18 h-12' src='/assets/horeca/icon-phone.png'></img>
                    </div>
                    <div>
                        <p className="text-lg text-dark leading-tight">Déjanos tu número<br></br> <span className='font-bold'>y te llamamos en unos minutos</span></p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <label className={`flex items-start gap-3 cursor-pointer group transition-transform ${showTooltip ? 'animate-bounce text-red-600' : ''}`}>
                        ...
                        <span className={`text-md text-gray-500 leading-tight ${showTooltip ? 'text-red-600 font-bold' : 'text-gray-500'}`}>
                    ...
                    >
                        ...
                        <ChevronRight className="w-6 h-9 pt-1" />
                    </button>
                </div>
            </div >
        </section >
