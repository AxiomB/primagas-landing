...
export const HeroBlockComponent: React.FC = ({
    ...
    return (
        <section id="hero-header bg-grey/20">
            <section className="relative flex flex-col md:block md:min-h-[70dvh] overflow-visible">
                <div className="absolute w-full h-[40dvh] md:h-full md:inset-0 z-0">
                    <img
                ...
                <div className="backdrop-brightness-60 md:backdrop-brightness-100 relative z-10 max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center py-10 md:py-24">
                    <motion.div
                        ...
                        className="text-[#df2b2a] md:mb-10 lg:mb-10"
                    >
                        ...
                        <p className="mt-3 text-white text-base max-w-md">
                            {subText}
                        </p>
                    </motion.div>
                </div>
                <motion.div
                    ...
                    className="
                relative z-20
                flex flex-col gap-4 px-6 pb-10 flex-end w-full
                md:absolute md:bottom-0 md:left-1/2 md:-translate-x-1/2 md:translate-y-1/2
                md:flex-row md:gap-6 md:pb-0 md:w-full md:max-w-8xl md:justify-center
            "
                >
                    <button className="
            ...
            "
                    ...
                    >
                        ...
                        <span className="text-white text-sm leading-tight text-left">
                            VER OFERTA GLP<br />PARA HOGARES
                        </span>
                    </button>
                    ...
                    <button
                        ...
                        <span className="text-white text-sm leading-tight text-left">
                            VER OFERTA GLP<br />PARA NEGOCIOS
                        </span>
                    </button>
                </motion.div>
            </section>
